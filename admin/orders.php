  ...
  <?php while($order = mysqli_fetch_assoc($orders)): ?>
    ...
    <?php endif; ?>
      ...
      <div class="items">
        <?php
          $order_id = $order['id'];
          $items = mysqli_query($conn, "SELECT order_items.*, books.title FROM order_items LEFT JOIN books ON order_items.book_id = books.id WHERE order_items.order_id = $order_id") or die(mysql_error());
